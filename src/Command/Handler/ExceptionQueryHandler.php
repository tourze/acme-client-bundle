...
final class ExceptionQueryHandler implements QueryHandlerInterface
{
    ...
    public function handle(SymfonyStyle $io, array $options): int
    {
        try {
            ...
            $exceptions = $this->logQueryService->queryExceptionLogs(
                $entityType,
                $entityId,
                $since,
                $limit
            ...
            $this->logDisplayService->displayExceptionLogsResults(
                $io,
                $exceptions,
                $entityType,
                $entityId,
