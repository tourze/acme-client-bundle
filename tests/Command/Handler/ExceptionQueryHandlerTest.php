...
use Tourze\ACMEClientBundle\Command\Handler\ExceptionQueryHandler;
use Tourze\PHPUnitSymfonyKernelTest\AbstractIntegrationTestCase;

/**
 * @internal
 */
#[CoversClass(ExceptionQueryHandler::class)]
#[RunTestsInSeparateProcesses]
final class ExceptionQueryHandlerTest extends AbstractIntegrationTestCase
{
    ...
    private function createHandler(): ExceptionQueryHandler
    {
        return self::getService(ExceptionQueryHandler::class);
    }

    public function testSupportsWhenTypeIsException(): void
    {
    ...
    public function testSupportsWhenTypeIsNotException(): void
    {
